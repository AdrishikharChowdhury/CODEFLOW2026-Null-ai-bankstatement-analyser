...
const Footer = () => {
  ...
  return (
    <footer className="w-full border-t border-border bg-card px-6 py-12">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="rounded-full border border-border p-2 text-primary transition-colors hover:border-primary hover:bg-primary/10 hover:text-primary"
              >
